...
public class DormitoryRuleActivity extends AppCompatActivity //기숙사 규칙 액티비티
{
    ...
    private final Context mContext = DormitoryRuleActivity.this;
    ...
    //웹뷰 함수
    {
        ...
        webView.loadUrl("https://www.gyh-dormitory.com/blank"); //경주 연합 기숙사 수칙
