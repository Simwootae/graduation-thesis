...
public class DonggukBusstopActivity extends AppCompatActivity //동국대 -> 연합기숙사
{
    ...
    private final Context mContext = DonggukBusstopActivity.this;
    ...
    String data;
    String city = "37020";
    String busstopcode = "KUB352000533";
    ////////////////////////////////////////////////////////////////////////////////////////////////
    @Override
    ...
    public void buttonfunction()//버튼 함수
    {
        ...
        {
            Intent intent = new Intent(getApplicationContext(), WhereDonggukBusstopActivity.class);
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        if (tag.equals("item"))
                        {
                            ...
                            {
                                if (busNumber.equals("50") || busNumber.equals("41") )
                                {
